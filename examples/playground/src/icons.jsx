// Inline icon set — original 1.5px stroke, single-color, current-color.
const Icon = ({ name, size = 16, ...rest }) => {
  const s = { width: size, height: size, ...(rest.style || {}) };
  const props = { ...rest, style: s, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.6, strokeLinecap: "round", strokeLinejoin: "round" };
  switch (name) {
    case "github":
